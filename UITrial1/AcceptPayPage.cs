...
public class AcceptPayPage : ContentPage
{

	public static MasterDetailPage MasterDetailPage;

	public AcceptPayPage ()
	{

		AcceptPayGridView S = new AcceptPayGridView ();
		this.Content = S;
		BackgroundColor = Color.FromHex ("E3F2FD");

//		MasterDetailPage = new MasterDetailPage {
//			Master = new MenuPage(),
//						Detail = new NavigationPage(S),
//						};
//		this.Content = MasterDetailPage;
